 ...
 */
var BlockListener = function (_Listener) {
  _inherits(BlockListener, _Listener);

  function BlockListener() {
    _classCallCheck(this, BlockListener);

    return _possibleConstructorReturn(this, (BlockListener.__proto__ || Object.getPrototypeOf(BlockListener)).apply(this, arguments));
  }

  _createClass(BlockListener, [{
    key: 'newBlock',
     ...
     */
    value: function newBlock(callback) {
