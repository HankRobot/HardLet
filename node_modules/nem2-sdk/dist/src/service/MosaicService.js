...
class MosaicService {
    ...
    mosaicsAmountView(mosaics) {
        return rxjs_1.of(mosaics).pipe(operators_1.mergeMap((_) => _), operators_1.mergeMap((mosaic) => this.mosaicsView([new MosaicId_1.MosaicId(mosaic.id.id.toDTO())]).pipe(operators_1.filter((_) => _.length !== 0), operators_1.map((mosaicViews) => {
