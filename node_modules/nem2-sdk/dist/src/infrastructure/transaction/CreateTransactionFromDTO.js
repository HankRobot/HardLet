...
const CreateStandaloneTransactionFromDTO = (transactionDTO, transactionInfo) => {
    if (transactionDTO.type === TransactionType_1.TransactionType.TRANSFER) {
        ...
        const recipient = transactionDTO.recipient;
        return new SecretProofTransaction_1.SecretProofTransaction(exports.extractNetworkType(transactionDTO.version), exports.extractTransactionVersion(transactionDTO.version), Deadline_1.Deadline.createFromDTO(transactionDTO.deadline), new UInt64_1.UInt64(transactionDTO.maxFee || [0, 0]), transactionDTO.hashAlgorithm, transactionDTO.secret, typeof recipient === 'object' && recipient.hasOwnProperty('address') ?
            Address_1.Address.createFromRawAddress(recipient.address) : Address_1.Address.createFromEncoded(recipient), transactionDTO.proof, transactionDTO.signature, transactionDTO.signer ? PublicAccount_1.PublicAccount.createFromPublicKey(transactionDTO.signer, exports.extractNetworkType(transactionDTO.version)) : undefined, transactionInfo);
    }
    ...
    else if (transactionDTO.type === TransactionType_1.TransactionType.MODIFY_ACCOUNT_RESTRICTION_OPERATION) {
        return new AccountOperationRestrictionModificationTransaction_1.AccountOperationRestrictionModificationTransaction(exports.extractNetworkType(transactionDTO.version), exports.extractTransactionVersion(transactionDTO.version), Deadline_1.Deadline.createFromDTO(transactionDTO.deadline), new UInt64_1.UInt64(transactionDTO.maxFee || [0, 0]), transactionDTO.restrictionType, transactionDTO.modifications ? transactionDTO.modifications.map((modificationDTO) => new AccountRestrictionModification_1.AccountRestrictionModification(modificationDTO.type, modificationDTO.value)) : [], transactionDTO.signature, transactionDTO.signer ? PublicAccount_1.PublicAccount.createFromPublicKey(transactionDTO.signer, exports.extractNetworkType(transactionDTO.version)) : undefined, transactionInfo);
    }
        ...
        return new MosaicGlobalRestrictionTransaction_1.MosaicGlobalRestrictionTransaction(exports.extractNetworkType(transactionDTO.version), exports.extractTransactionVersion(transactionDTO.version), Deadline_1.Deadline.createFromDTO(transactionDTO.deadline), new UInt64_1.UInt64(transactionDTO.maxFee || [0, 0]), new MosaicId_1.MosaicId(transactionDTO.mosaicId), new MosaicId_1.MosaicId(transactionDTO.referenceMosaicId), new UInt64_1.UInt64(transactionDTO.restrictionKey), new UInt64_1.UInt64(transactionDTO.previousRestrictionValue), transactionDTO.previousRestrictionType, new UInt64_1.UInt64(transactionDTO.newRestrictionValue), transactionDTO.newRestrictionType, transactionDTO.signature, transactionDTO.signer ? PublicAccount_1.PublicAccount.createFromPublicKey(transactionDTO.signer, exports.extractNetworkType(transactionDTO.version)) : undefined, transactionInfo);
    }
        ...
        return new MosaicAddressRestrictionTransaction_1.MosaicAddressRestrictionTransaction(exports.extractNetworkType(transactionDTO.version), exports.extractTransactionVersion(transactionDTO.version), Deadline_1.Deadline.createFromDTO(transactionDTO.deadline), new UInt64_1.UInt64(transactionDTO.maxFee || [0, 0]), new MosaicId_1.MosaicId(transactionDTO.mosaicId), new UInt64_1.UInt64(transactionDTO.restrictionKey), typeof targetAddress === 'object' && targetAddress.hasOwnProperty('address') ?
            Address_1.Address.createFromRawAddress(targetAddress.address) : Address_1.Address.createFromEncoded(targetAddress), new UInt64_1.UInt64(transactionDTO.previousRestrictionValue), new UInt64_1.UInt64(transactionDTO.newRestrictionValue), transactionDTO.signature, transactionDTO.signer ? PublicAccount_1.PublicAccount.createFromPublicKey(transactionDTO.signer, exports.extractNetworkType(transactionDTO.version)) : undefined, transactionInfo);
    }
