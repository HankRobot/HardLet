...
const CreateTransaction = (type, transactionData, networkType, deadline) => {
    switch (type) {
        ...
        case TransactionType_1.TransactionType.SECRET_PROOF:
            ...
            const secretProofSecretLength = HashType_1.HashType.Op_Hash_160 === secretProofHashAlgorithm ? 40 : 64;
            ...
            return SecretProofTransaction_1.SecretProofTransaction.create(Deadline_1.Deadline.createFromDTO(deadline), secretProofHashAlgorithm, secretProofSecret, mosaicProof, networkType);
