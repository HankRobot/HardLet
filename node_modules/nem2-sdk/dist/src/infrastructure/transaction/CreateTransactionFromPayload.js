...
const CreateTransaction = (type, transactionData, networkType, deadline) => {
    switch (type) {
        ...
        case TransactionType_1.TransactionType.MOSAIC_GLOBAL_RESTRICTION:
            ...
            return MosaicGlobalRestrictionTransaction_1.MosaicGlobalRestrictionTransaction.create(Deadline_1.Deadline.createFromDTO(deadline), new MosaicId_1.MosaicId(UInt64_1.UInt64.fromHex(reverse(globalRestrictionMosaicId)).toDTO()), new MosaicId_1.MosaicId(UInt64_1.UInt64.fromHex(reverse(globalRestrictionReferenceMosaicId)).toDTO()), UInt64_1.UInt64.fromHex(reverse(globalRestrictionRestrictionKey)), UInt64_1.UInt64.fromHex(reverse(globalRestrictionPrevValue)), parseInt(format_1.Convert.uint8ToHex(format_1.Convert.hexToUint8(globalRestrictionPrevType).reverse()), 16), UInt64_1.UInt64.fromHex(reverse(globalRestrictionNewValue)), parseInt(format_1.Convert.uint8ToHex(format_1.Convert.hexToUint8(globalRestrictionNewType).reverse()), 16), networkType);
        case TransactionType_1.TransactionType.MOSAIC_ADDRESS_RESTRICTION:
            ...
            return MosaicAddressRestrictionTransaction_1.MosaicAddressRestrictionTransaction.create(Deadline_1.Deadline.createFromDTO(deadline), new MosaicId_1.MosaicId(UInt64_1.UInt64.fromHex(reverse(addressRestrictionMosaicId)).toDTO()), UInt64_1.UInt64.fromHex(reverse(addressRestrictionRestrictionKey)), Address_1.Address.createFromEncoded(addressRestrictionTargetAddress), UInt64_1.UInt64.fromHex(reverse(addressRestrictionPrevValue)), UInt64_1.UInt64.fromHex(reverse(addressRestrictionNewValue)), networkType);
