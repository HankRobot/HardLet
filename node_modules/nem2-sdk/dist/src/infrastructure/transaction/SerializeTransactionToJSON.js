...
exports.SerializeTransactionToJSON = (transaction) => {
    switch (transaction.type) {
        ...
        case TransactionType_1.TransactionType.MOSAIC_GLOBAL_RESTRICTION:
            return {
                mosaicId: transaction.mosaicId.toDTO(),
                referenceMosaicId: transaction.referenceMosaicId.toDTO(),
                restrictionKey: transaction.restrictionKey.toDTO(),
                previousRestrictionValue: transaction.previousRestrictionValue.toDTO(),
                previousRestrictionType: transaction.previousRestrictionType,
                newRestrictionValue: transaction.newRestrictionValue.toDTO(),
        ...
        case TransactionType_1.TransactionType.MOSAIC_ADDRESS_RESTRICTION:
            return {
                mosaicId: transaction.mosaicId.toDTO(),
                restrictionKey: transaction.restrictionKey.toDTO(),
                targetAddress: transaction.targetAddress.toDTO(),
                previousRestrictionValue: transaction.previousRestrictionValue.toDTO(),
                newRestrictionValue: transaction.newRestrictionValue.toDTO(),
            };
        default:
