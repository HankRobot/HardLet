...
class CosignatureTransaction {
     ...
     */
    static signTransactionPayload(account, payload, generationHash, signSchema = crypto_1.SignSchema.SHA3) {
        /**
         * For aggregated complete transaction, cosignatories are gathered off chain announced.
         */
        const transactionHash = VerifiableTransaction_1.VerifiableTransaction.createTransactionHash(payload, Array.from(Convert_1.Convert.hexToUint8(generationHash)));
