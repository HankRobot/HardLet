...
class EncryptedMessage extends Message_1.Message {
    ...
    static create(message, recipientPublicAccount, privateKey) {
        return new EncryptedMessage(nem2_library_1.crypto.encode(privateKey, recipientPublicAccount.publicKey, message).toUpperCase(), recipientPublicAccount);
    }
    /**
     *
     * @param payload
    ...
    static decrypt(encryptMessage, privateKey, recipientPublicAccount) {
        return new PlainMessage_1.PlainMessage(this.decodeHex(nem2_library_1.crypto.decode(privateKey, recipientPublicAccount.publicKey, encryptMessage.payload)));
    }
}
