...
export declare class TransactionType {
     ...
     * @type {number}
     */
    static readonly MODIFY_ACCOUNT_RESTRICTION_ADDRESS: number;
    /**
     * Account restriction mosaic transaction type
     * @type {number}
     */
    static readonly MODIFY_ACCOUNT_RESTRICTION_MOSAIC: number;
    /**
     * Account restriction operation transaction type
     * @type {number}
     */
    static readonly MODIFY_ACCOUNT_RESTRICTION_OPERATION: number;
    /**
