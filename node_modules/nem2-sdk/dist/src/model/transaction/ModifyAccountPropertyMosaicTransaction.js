...
class ModifyAccountPropertyMosaicTransaction extends Transaction_1.Transaction {
    /**
     * @param networkType
     * @param version
     * @param deadline
    ...
    constructor(networkType, version, deadline, maxFee, propertyType, modifications, signature, signer, transactionInfo) {
        super(TransactionType_1.TransactionType.MODIFY_ACCOUNT_PROPERTY_MOSAIC, networkType, version, deadline, maxFee, signature, signer, transactionInfo);
    ...
    static create(deadline, propertyType, modifications, networkType, maxFee = new UInt64_1.UInt64([0, 0])) {
        return new ModifyAccountPropertyMosaicTransaction(networkType, TransactionVersion_1.TransactionVersion.MODIFY_ACCOUNT_PROPERTY_MOSAIC, deadline, maxFee, propertyType, modifications);
    }
    /**
     ...
     */
    buildTransaction() {
        return new nem2_library_1.AccountPropertiesMosaicTransaction.Builder()
...
exports.ModifyAccountPropertyMosaicTransaction = ModifyAccountPropertyMosaicTransaction;
//# sourceMappingURL=ModifyAccountPropertyMosaicTransaction.js.map