...
class MosaicId {
    ...
    static createFromNonce(nonce, owner) {
        const mosaicId = nem2_library_1.mosaicId(nonce.nonce, nem2_library_1.convert.hexToUint8(owner.publicKey));
    ...
    constructor(id) {
        if (id instanceof Array) {
            ...
            this.id = new Id_1.Id(nem2_library_1.uint64.fromHex(id));
        }
    }
    /**
